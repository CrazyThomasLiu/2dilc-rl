...
#F_A=np.array([[0.0804,0.,0.],[-0.0304,0.,0.],[-0.0464,0.,0.]])
F_A=np.array([[0.0804,-0.0304,-0.0464],[0.,0.,0.],[0.,0.,0.]])
#F_A=np.array([[0.0804,0.,0.],[0.,-0.0304,0.],[0.,0.,-0.0464]])
F_B=np.array([[0.062],[0.],[0.]])


'3. The PI control law'
#K_p=np.array([[0.97204311]])
#K_i=([[0.05269451858680813]])
#K_p=np.array([[0.98285041]])
#K_i=([[0.047549667260606075]])
#K_p=np.array([[0.86607589]])
#K_i=([[0.03921978142957267]])
K_p=np.array([[0.99993268]])
K_i=([[0.04862066771417882]])
#K_p=np.array([[0.97733696]])
#K_i=([[0.0522867752675946]])
