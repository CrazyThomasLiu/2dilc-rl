from run_for_practical_nonlinear_batch_reactor import *
from agent_practical_nonlinear_batch_reactor import AgentModSAC
import pdb
import os
import sys
import control
...
args.cwd = os.path.join(current_dir, 'runs_AgentModSAC_nonlinear_batch_reactor_practical/1')
