...
ax.view_init(40, -19)
plt.savefig('discrete_time_out.png',dpi=700)
plt.show()
#2. control signal
...
ax.set_ylabel(ylable,font2)
ax.view_init(40, -19)
plt.savefig('discrete_time_input.png',dpi=700)
plt.show()
#10000.SAE
SAE=np.zeros(batch)
...
with open('./timesinus.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
...
plt.savefig('discrete_time_RMES.png',dpi=700)
plt.show()
pdb.set_trace()
a=2