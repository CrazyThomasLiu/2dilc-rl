...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('SISO_CSTR_output_time_batch.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('SISO_CSTR_input_time_batch.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
if save_csv==True:
    with open('model_time_batch.csv', 'w', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)
...
if save_figure==True:
    plt.savefig('SISO_CSTR_RMSE_time_batch.png',dpi=700)
plt.show()
pdb.set_trace()
a=2