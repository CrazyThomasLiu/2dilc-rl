...
K=np.array([[ 1755.71779627, -3219.85907099, 1764.6433828 ]])
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('SISO_CSTR_output_90%.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('SISO_CSTR_input_90%.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
if save_csv==True:
    csv_name = f'./RMSE_90%.csv'
    #with open('./2dilc.csv', 'w', encoding='UTF8', newline='') as f:
...
if save_figure==True:
    plt.savefig('SISO_CSTR_RMSE_90%.png',dpi=700)
plt.show()
pdb.set_trace()
a=2