...
for batch_index in range(batch):
    ...
    for item in range(T_length):
        ...
        if u_k[0,0]>constrain:
            u_k[0,0]=constrain
        elif u_k[0,0]<-constrain:
            u_k[0,0]=-constrain
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('SISO_CSTR_output_time_batch_e5.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('SISO_CSTR_input_time_batch_e5.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
if save_csv==True:
    with open('model_time_batch_constrain_e5.csv', 'w', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)
...
if save_figure==True:
    plt.savefig('SISO_CSTR_RMSE_time_batch_e5.png',dpi=700)
plt.show()
pdb.set_trace()
a=2