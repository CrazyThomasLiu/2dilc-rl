...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('constrain_5000_n5000_y1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('constrain_5000_n5000_y2.png',dpi=700)
#plt.show()
#pdb.set_trace()
"2.Input Signal"
font2 = {'family': 'Times New Roman',
...
#ax.view_init(0, 90)
if save_figure==True:
    plt.savefig('constrain_5000_n5000_u1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
#ax.view_init(0, 90)
if save_figure==True:
    plt.savefig('constrain_5000_n5000_u2.png',dpi=700)
plt.show()
#pdb.set_trace()
...
with open('./constrain_500_n500_y1.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
...
with open('./constrain_500_n500_y2.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)

    # write multiple rows

    writer.writerows(map(lambda x: [x], SAE_y2))
with open('./constrain_500_n500_sum.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
...
if save_figure==True:
    plt.savefig('constrain_5000_n5000_SAE.png',dpi=700)
...
if save_figure==True:
    plt.savefig('constrain_5000_n5000_total_SAE.png',dpi=700)
