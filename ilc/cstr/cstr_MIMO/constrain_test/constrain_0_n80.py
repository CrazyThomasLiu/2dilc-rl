...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('constrain_0_n80_y1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('constrain_0_n80_y2.png',dpi=700)
#plt.show()
#pdb.set_trace()
"2.Input Signal"
font2 = {'family': 'Times New Roman',
...
#ax.view_init(0, 90)
if save_figure==True:
    plt.savefig('constrain_0_n80_u1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
#ax.view_init(0, 90)
if save_figure==True:
    plt.savefig('constrain_0_n80_u2.png',dpi=700)
plt.show()
#pdb.set_trace()
...
if save_figure==True:
    plt.savefig('constrain_0_n80_SAE.png',dpi=700)
...
if save_figure==True:
    plt.savefig('constrain_0_n80_total_SAE.png',dpi=700)
