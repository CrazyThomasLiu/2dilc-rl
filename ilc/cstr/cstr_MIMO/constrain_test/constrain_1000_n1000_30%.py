...
if save_csv==True:
    ...
    with open('./constrain_1000_n1000_30%_y1.csv', 'w', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)
    ...
    with open('./constrain_1000_n1000_30%_y2.csv', 'w', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)

        # write multiple rows

        writer.writerows(map(lambda x: [x], SAE_y2))
    with open('./constrain_1000_n1000_30%_sum.csv', 'w', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)
...
if save_figure==True:
    plt.savefig('constrain_1000_n1000_30%_RMSE.png',dpi=700)
...
if save_figure==True:
    plt.savefig('constrain_1000_n1000_total_30%_RMSE.png',dpi=700)
