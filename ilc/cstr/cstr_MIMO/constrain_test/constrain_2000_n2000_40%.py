...
#ax.view_init(0, 90)
if save_figure==True:
    plt.savefig('constrain_2000_n2000_40%_u1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
#ax.view_init(0, 90)
if save_figure==True:
    plt.savefig('constrain_2000_n2000_40%_u2.png',dpi=700)
plt.show()
#pdb.set_trace()
...
if save_csv==True:
    ...
    with open('./constrain_2000_n2000_40%_y1.csv', 'w', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)
    ...
    with open('./constrain_2000_n2000_40%_y2.csv', 'w', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)

        # write multiple rows

        writer.writerows(map(lambda x: [x], SAE_y2))
    with open('./constrain_2000_n2000_40%_sum.csv', 'w', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)
...
if save_figure==True:
    plt.savefig('constrain_2000_n2000_40%_RMSE.png',dpi=700)
...
if save_figure==True:
    plt.savefig('constrain_2000_n2000_total_40%_RMSE.png',dpi=700)
