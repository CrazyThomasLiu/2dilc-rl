...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('constrain_0_n500_y1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
#ax.view_init(0, 90)
if save_figure==True:
    plt.savefig('constrain_0_n500_u1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
#ax.view_init(0, 90)
if save_figure==True:
    plt.savefig('constrain_0_n500_u2.png',dpi=700)
plt.show()
#pdb.set_trace()
...
if save_figure==True:
    plt.savefig('constrain_0_n500_SAE.png',dpi=700)
...
if save_figure==True:
    plt.savefig('constrain_0_n500_total_SAE.png',dpi=700)
