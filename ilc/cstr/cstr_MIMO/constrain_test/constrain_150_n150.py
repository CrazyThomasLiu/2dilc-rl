...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('constrain_150_n150_y1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('constrain_0_n500_y2.png',dpi=700)
#plt.show()
#pdb.set_trace()
"2.Input Signal"
font2 = {'family': 'Times New Roman',
...
#ax.view_init(0, 90)
if save_figure==True:
    plt.savefig('constrain_150_n150_u1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
#ax.view_init(0, 90)
if save_figure==True:
    plt.savefig('constrain_150_n150_u2.png',dpi=700)
plt.show()
#pdb.set_trace()
...
if save_figure==True:
    plt.savefig('constrain_150_n150_SAE.png',dpi=700)
...
if save_figure==True:
    plt.savefig('constrain_150_n150_total_SAE.png',dpi=700)
