...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('constrain_0_n150_y1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('constrain_0_n150_y2.png',dpi=700)
#plt.show()
#pdb.set_trace()
"2.Input Signal"
font2 = {'family': 'Times New Roman',
...
#ax.view_init(0, 90)
if save_figure==True:
    plt.savefig('constrain_0_n150_u1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
#ax.view_init(0, 90)
if save_figure==True:
    plt.savefig('constrain_0_n150_u2.png',dpi=700)
plt.show()
#pdb.set_trace()
...
with open('./constrain_0_n150_y1.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
...
with open('./constrain_0_n150_y2.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)

    # write multiple rows

    writer.writerows(map(lambda x: [x], SAE_y2))
with open('./constrain_0_n150_sum.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
...
if save_figure==True:
    plt.savefig('constrain_0_n150_SAE.png',dpi=700)
