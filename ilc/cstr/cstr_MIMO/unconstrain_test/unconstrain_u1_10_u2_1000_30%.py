...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('unconstrain_u1_10_u2_1000_30%_y1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('unconstrain_u1_10_u2_1000_30%_y2.png',dpi=700)
#plt.show()
#pdb.set_trace()
"2.Input Signal"
font2 = {'family': 'Times New Roman',
...
#ax.view_init(0, 90)
if save_figure==True:
    plt.savefig('unconstrain_u1_10_u2_1000_30%_u1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
#ax.view_init(0, 90)
if save_figure==True:
    plt.savefig('unconstrain_u1_10_u2_1000_30%_u2.png',dpi=700)
plt.show()
#pdb.set_trace()
...
if save_csv==True:
    ...
    with open('../unconstrain_test/unconstrain_u1_10_u2_1000_30%_y1.csv', 'w', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)
    ...
    with open('../unconstrain_test/unconstrain_u1_10_u2_1000_30%_y2.csv', 'w', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)

        # write multiple rows

        writer.writerows(map(lambda x: [x], SAE_y2))
    with open('../unconstrain_test/unconstrain_u1_10_u2_1000_30%_sum.csv', 'w', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)
...
if save_figure==True:
    plt.savefig('unconstrain_u1_10_u2_1000_30%_RMSE.png',dpi=700)
...
if save_figure==True:
    plt.savefig('unconstrain_u1_10_u2_1000_30%_sum_RMSE.png',dpi=700)
