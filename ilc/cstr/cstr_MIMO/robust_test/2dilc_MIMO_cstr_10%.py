...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('MIMO_cstr_10%_y1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('MIMO_cstr_10%_y2.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('MIMO_cstr_10%_u1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('MIMO_cstr_10%_u2.png',dpi=700)
plt.show()
#pdb.set_trace()
...
if save_figure==True:
    plt.savefig('MIMO_cstr_10%_SAE_long.png',dpi=700)
plt.show()
pdb.set_trace()
a=2