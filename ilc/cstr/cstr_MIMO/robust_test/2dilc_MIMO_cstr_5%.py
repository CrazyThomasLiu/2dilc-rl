...
K=np.array([[-153.76932166,  -65.60325631,   54.557875  ,   54.56175758],
       [ -20.956439  ,  -25.42862123,    1.5381249 ,    1.59931438]])
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('MIMO_cstr_5%_y1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('MIMO_cstr_5%_y2.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('MIMO_cstr_5%_u1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('MIMO_cstr_5%_u2.png',dpi=700)
plt.show()
#pdb.set_trace()
...
if save_figure==True:
    plt.savefig('MIMO_cstr_5%_SAE_long.png',dpi=700)
plt.show()
pdb.set_trace()
a=2