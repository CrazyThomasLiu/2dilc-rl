...
for batch_index in range(batch_SAE):
    ...
    for item in range(T_length):
        ...
        #print(item)
        #pdb.set_trace()
        t_step, y_step, x_step = control.input_output_response(Nonlinear_CSTR, T, response_input, X0=X0, return_x=True,method='LSODA')
        #pdb.set_trace()
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('MIMO_cstr_40%_time_y1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('MIMO_cstr_40%_time_y2.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('MIMO_cstr_40%_time_u1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('MIMO_cstr_40%_time_u2.png',dpi=700)
plt.show()
#pdb.set_trace()
...
with open('./2dilc_MIMO_cstr_40%_time_y1.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
...
with open('./2dilc_MIMO_cstr_40%_time_y2.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
...
if save_figure==True:
    plt.savefig('MIMO_cstr_40%_time_SAE.png',dpi=700)
plt.show()
pdb.set_trace()
a=2