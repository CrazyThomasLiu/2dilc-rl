...
#K=np.array([[-125.95548929,  -76.61648402,   26.45077853,   26.32156906],
#[  -5000.77273917, -105.40756758,   -0.58048133,   -0.55630634]])

K=np.array([[-128.25834152,  -37.22429247,   26.32291953,   26.24543231],
       [  -7.27647933,   -5.12522323,   -0.20213443,   -0.19329782]])
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('constrain_1000_15000_y1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('constrain_1000_n1000_y2.png',dpi=700)
#plt.show()
#pdb.set_trace()
"2.Input Signal"
font2 = {'family': 'Times New Roman',
...
#ax.view_init(0, 90)
if save_figure==True:
    plt.savefig('constrain_1000_n1000_u1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
#ax.view_init(0, 90)
if save_figure==True:
    plt.savefig('constrain_1000_n1000_u2.png',dpi=700)
plt.show()
#pdb.set_trace()
...
if save_csv==True:
    ...
    with open('./constrain_1000_n1000_y1.csv', 'w', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)
    ...
    with open('./constrain_1000_n1000_y2.csv', 'w', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)

        # write multiple rows

        writer.writerows(map(lambda x: [x], SAE_y2))
    with open('./constrain_1000_n1000_sum.csv', 'w', encoding='UTF8', newline='') as f:
        writer = csv.writer(f)
...
if save_figure==True:
    plt.savefig('constrain_1000_n1000_SAE.png',dpi=700)


"10000.10000 Plot of the sum SAE"
...
if save_figure==True:
    plt.savefig('constrain_1000_n1000_total_SAE.png',dpi=700)
