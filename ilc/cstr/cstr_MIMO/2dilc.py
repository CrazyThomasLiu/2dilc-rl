...
ax.view_init(40, -19)
plt.savefig('MIMO_cstr_y1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
#ax.legend(['y_Ref','y_out'])
#ax.view_init(52, -16)
plt.savefig('MIMO_cstr_y2.png',dpi=700)
ax.view_init(40, -19)
...
ax.view_init(52, -16)
ax.view_init(40, -19)
plt.savefig('MIMO_cstr_u1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
ax.view_init(52, -16)
ax.view_init(40, -19)
plt.savefig('MIMO_cstr_u2.png',dpi=700)
plt.show()
#pdb.set_trace()
...
plt.savefig('2dilc_MIMOcstr_SAE.png',dpi=700)
plt.show()
pdb.set_trace()
a=2