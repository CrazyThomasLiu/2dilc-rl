...
K=np.array([[-155.66184111,  -64.42276585,   40.62532564,   40.62279347],
       [ -91.98682253, -172.18196642,    7.71891784,    7.7637387 ]])
"""
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('MIMO_cstr_10%_time_y1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('MIMO_cstr_10%_time_y2.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('MIMO_cstr_10%_time_u1.png',dpi=700)
#plt.show()
#pdb.set_trace()
...
ax.view_init(40, -19)
if save_figure==True:
    plt.savefig('MIMO_cstr_10%_time_u2.png',dpi=700)
plt.show()
#pdb.set_trace()
...
if save_figure==True:
    plt.savefig('MIMO_cstr_10%_time_SAE.png',dpi=700)
plt.show()
pdb.set_trace()
a=2