...
# Simulate the system
"RK45"
t_con_1, y_con_1 = control.input_output_response(Nonlinear_CSTR, T, 5., X0,method='RK45')
"DOP853"
t_con_2, y_con_2 = control.input_output_response(Nonlinear_CSTR, T, 5., X0,method='DOP853')
"BDF"
t_con_3, y_con_3 = control.input_output_response(Nonlinear_CSTR, T, 5., X0,method='BDF')
"Radau"
t_con_4, y_con_4 = control.input_output_response(Nonlinear_CSTR, T, 5., X0,method='Radau')
"LSODA"
t_con_5, y_con_5 = control.input_output_response(Nonlinear_CSTR, T, 5., X0,method='LSODA')
# Plot the response
plt.figure(1)
