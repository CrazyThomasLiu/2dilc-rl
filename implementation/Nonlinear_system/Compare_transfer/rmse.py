...
ILC_dir=os.path.join(current_dir, "model_time_batch.csv")
...
ILC_dir=os.path.join(current_dir, "2DILC-RL_training_finished.csv")
f_ILC=open(ILC_dir,'r')
num=0
...
batch_time=range(1+2000,batch_rmse+1+2000)
plt.figure()
