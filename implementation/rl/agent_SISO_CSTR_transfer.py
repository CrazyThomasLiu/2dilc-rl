...
from net import Actor, ActorPPO, ActorSAC, ActorDiscretePPO
...
class AgentBase:
    ...
    def explore_one_env(self, env, target_step, time_length=300):
...
class AgentDDPG(AgentBase):
    ...
    def update_net(self, buffer, batch_size, repeat_times, soft_update_tau) -> (float, float):
        ...
        for _ in range(int(buffer.now_len / batch_size * repeat_times)):
            ...
            #pdb.set_trace()
            # show if the parameters of Actor, critic is changing
        #pdb.set_trace()
