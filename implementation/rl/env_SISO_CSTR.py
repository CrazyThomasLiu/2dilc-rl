...
class BatchSysEnv:
    ...
    def __init__(self,T_length,sys,T=0.01,X0=np.array((0.5, 310.)),action_co=10000.):
        ...
        #self.y_k_last = np.repeat(np.array([[310.]]),T_length+1,axis=0)
    ...
    def step(self,action):
        ...
        """
        if self.input_signal[0,0] > 100000:
            self.input_signal[0, 0] = 100000
        elif self.input_signal[0,0] < -100000:
            self.input_signal[0, 0] = -100000
        """
