...
sys = BatchSysEnv(T_length=T_length, sys=batch_system, X0=X0,action_co=10)

"""give the path"""
current_path = os.path.abspath(__file__)
current_dir = os.path.dirname(current_path)
#pdb.set_trace()
data_dir=os.path.join(current_dir, "runs2_ilcinrl/10")
...
plt.savefig('ilcincl_batch_RMES_action10_longbatch.png',dpi=700)
plt.show()
