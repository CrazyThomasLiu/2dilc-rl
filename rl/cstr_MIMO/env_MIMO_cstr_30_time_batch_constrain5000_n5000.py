...
class BatchSysEnv:
    ...
    def step(self,action):
        ...
        if self.input_signal[1,0] < -5000:
            self.input_signal[1,0] = -5000
        elif self.input_signal[1,0] > 5000:
            self.input_signal[1,0] = 5000
    ...
    def cal_2DILCcontroller(self):
        ...
        # input 2 is the cooling so only negative
        if self.u_k[1, 0] < -5000:
            self.u_k[1, 0] = -5000
        elif self.u_k[1, 0] > 5000:
            self.u_k[1, 0] =5000
