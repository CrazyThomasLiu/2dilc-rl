...
#pdb.set_trace()
data_dir=os.path.join(current_dir, "runs2/20")
...
ax.view_init(40, -19)
plt.savefig('batch_out_action20.png',dpi=700)
plt.show()
#pdb.set_trace()
#2. RL control signal
...
ax.set_ylabel(ylable,font2)
ax.view_init(40, -19)
plt.savefig('batch_inputrl_action20.png',dpi=700)
plt.show()
#pdb.set_trace()
...
ax.set_ylabel(ylable,font2)
ax.view_init(40, -19)
plt.savefig('batch_inputilc_action20.png',dpi=700)
plt.show()
#pdb.set_trace()
...
plt.savefig('batch_RMES_action20.png',dpi=700)
plt.show()
