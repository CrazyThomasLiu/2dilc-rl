...
def train_and_evaluate(args, agent_id=0):
    ...
    while os.path.exists(distance_path):
        number += 1
        distance_path = os.path.join(current_dir, "AgentModSAC_Linearsys_SISO_Step_{number}".format(number=number))
        #distance_path = os.path.join(current_dir, "AgentModSAC_Linearsys_SISO_test_{number}".format(number=number))
