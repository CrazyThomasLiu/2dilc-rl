...
ILCsac_dir=os.path.join(current_dir, "constrain_1000_n1000_30%_SAE_y1.csv")
...
with f_ILC:
    ...
    for row in reader:
        ...
        num+=1
ILCsac_dir=os.path.join(current_dir, "constrain_1000_n1000_30%_SAE_y2.csv")
f_ILC=open(ILCsac_dir,'r')
num=0
...
ILCsac_dir=os.path.join(current_dir, "constrain_1000_n1000_30%_SAE_sum.csv")
f_ILC=open(ILCsac_dir,'r')
num=0
