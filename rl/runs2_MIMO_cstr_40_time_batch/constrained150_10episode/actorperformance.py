...
ILCsac_dir=os.path.join(current_dir, "2dilc_MIMO_cstr_40%_time_batch_constrained150_y1.csv")
...
with f_ILC:
    ...
    for row in reader:
        ...
        num+=1
ILCsac_dir=os.path.join(current_dir, "2dilc_MIMO_cstr_40%_time_batch_constrained150_y2.csv")
f_ILC=open(ILCsac_dir,'r')
num=0
